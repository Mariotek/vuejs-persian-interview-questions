---
title: "مجموعه سوال و جواب‌های vuejs"
...
|12 | [متد هایی که باعث تغییر ارایه میشن و باعث اپدیت view میشن کدوما هستن؟](#متد-هایی-که-باعث-تغییر-ارایه-میشن-و-باعث-اپدیت-view-میشن-کدوما-هستن؟)|
|13 | [متد هایی که باعث تغییر ارایه نمیشن و باعث اپدیت view میشن کدوما هستن؟](#متد-هایی-که-باعث-تغییر-ارایه-نمیشن-و-باعث-اپدیت-view-میشن-کدوما-هستن؟)|
|14 | [چه چیزایی رو باید درمورد حساسیت به تغییر ارایه ها بدونیم؟](#چه-چیزایی-رو-باید-درمورد-حساسیت-به-تغییر-ارایه-ها-بدونیم؟)|
|15 | [چه چیزایی رو باید درمورد حساسیت به تغییر object ها بدونیم؟](#چه-چیزایی-رو-باید-درمورد-حساسیت-به-تغییر-object-ها-بدونیم؟)|
|16 | [چطوری میتونیم از دستورالعمل v-for برای یه رنج مشخص استفاده کنیم؟](#چطوری-میتونیم-از-دستورالعمل-v-for-برای-یه-رنج-مشخص-استفاده-کنیم؟)|
|17 | [چطوری از دستورالعمل v-for روی template ها استفاده کنیم؟](#چطوری-از-دستورالعمل-v-for-روی-template-ها-استفاده-کنیم؟)|
|18 | [چطوری متونیم از event handler ها استفاده کنیم؟](#چطوری-متونیم-از-event-handler-ها-استفاده-کنیم؟)|
|19 | [اصلاح کننده هایی که توسط ویو ارائه میشن کدوما هستن؟](#اصلاح-کننده-هایی-که-توسط-ویو-ارائه-میشن-کدوما-هستن؟)|
|20 | [اصلاح کننده های اصلی کدوما هستن؟](#اصلاح-کننده-های-اصلی-کدوما-هستن؟1)|
|21 | [چطوری میتونیم برای یه اصلاح کننده اصلی خلاصه شده بنویسیم؟](#چطوری-میتونیم-برای-یه-اصلاح-کننده-اصلی-خلاصه-شده-بنویسیم؟)|
|22 | [اصلاح کننده های سیستمی که توسط ویو پشتیبانی میشن کدوما هستن؟](#اصلاح-کننده-های-سیستمی-که-توسط-ویو-پشتیبانی-میشن-کدوما-هستن؟)|
|23 | [اصلاح کننده های مربوط به موس کدوما هستن؟](#اصلاح-کننده-های-مربوط-به-موس-کدوما-هستن؟)|
|24 | [چطوری دیتا رو به صورت دو طرفه bind میکنی؟](#چطوری-دیتا-رو-به-صورت-دو-طرفه-bind-میکنی؟)|
|25 | [اصلاح کننده های پشتیبانی شده روی model چیا هستن؟](#اصلاح-کننده-های-پشتیبانی-شده-روی-model-چیا-هستن؟)|
|26 | [کامپوننت ها چیا هستن یه مثال درموردش بزن؟](#کامپوننت-ها-چیا-هستن-یه-مثال-درموردش-بزن؟)|
|27 | [پراپ ها چیا هستن؟](#پراپ-ها-چیا-هستن؟)|
|28 | [کی یه کمپوننت به یه عنصر روت نیاز داره؟](#کی-یه-کمپوننت-به-یه-عنصر-روت-نیاز-داره؟)|
|29 | [چطوری از سمت کامپوننت فرزند به سمت کامپوننت بالا دیتا  میفرستی؟](#چطوری-از-سمت-کامپوننت-فرزند-به-سمت-کامپوننت-بالا-دیتا--میفرستی؟)|
|30 | [چطوری یه مدل روی یه custom input اجرا میکنی؟](#چطوری-یه-مدل-روی-یه-custom-input-اجرا-میکنی؟)|
|31 | [slot ها چیا هستن؟](#slot-ها-چیا-هستن؟)|
|32 | [منظور از global registration توی یه کامپوننت چیه؟](#1)|
|33 | [چرا به local registration نیاز داریم؟](#چرا-به-local-registration-نیاز-داریم؟)|
|34 | [تفاوت بین local و global registration توی یه سیستم ماژولار چیه؟](#تفاوت-بین-local-و-global-registration-توی-یه-سیستم-ماژولار-چیه؟)|
|35 | [تایپ های قابل استفاده برای پراپ ها چیا هستن؟](#تایپ-های-قابل-استفاده-برای-پراپ-ها-چیا-هستن؟)|
|36 | [data flow مربوط به پراپ ها چطوری هست؟](#data-flow-مربوط-به-پراپ-ها-چطوری-هست؟)|
|37 | [منظور از اتربیوت های non prop چیه؟](#منظور-از-اتربیوت-های-non-prop-چیه؟)|
|38 | [اعتبار سنجی هایی که برای پراپ ها داریم چیا هستن؟](#اعتبار-سنجی-هایی-که-برای-پراپ-ها-داریم-چیا-هستن؟)|
|39 | [چطوری میتونیم دستورالعمل model رو برای یه کامپوننت کاستومایز کنیم؟](#چطوری-میتونیم-دستورالعمل-model-رو-برای-یه-کامپوننت-کاستومایز-کنیم؟)|
|40 | [چطوری میتونیم یه transition تنظیم کنیم؟](#چطوری-میتونیم-یه-transition-تنظیم-کنیم؟)|
|41 | [vue router چیه و چه قابلیت هایی داره؟](#vue-router-چیه-و-چه-قابلیت-هایی-داره؟)|
|42 | [قدم هایی که برای کانفیگ vue router لازمه برداشته شه چیا هستن؟](#قدم-هایی-که-برای-کانفیگ-vue-router-لازمه-برداشته-شه-چیا-هستن؟)|
|43 | [منظور از dynamic route چیه؟](#منظور-از-dynamic-route-چیه؟)|
|44 | [چطوری تفییرات param رو سریع انجام بدیم؟](#چطوری-تفییرات-param-رو-سریع-انجام-بدیم؟)|
|45 | [منظور از اولویت توی route matching چیه؟](#منظور-از-اولویت-توی-route-matching-چیه؟)|
|46 | [منظور از nasted route چیه؟](#منظور-از-nasted-route-چیه؟)|
|47 | [منظور از single file component چیه؟](#منظور-از-single-file-component-چیه؟)|
|48 | [single File component ها استاندارد تفکیک کد رو نقض میکنه؟](#single-File-component-ها-استاندارد-تفکیک-کد-رو-نقض-میکنه؟)|
|49 | [چه مشکلایی با single file component ها حل میشن؟](#چه-مشکلایی-با-single-file-component-ها-حل-میشن؟)|
|50 | [فیلتر ها چیا هستن؟](#فیلتر-ها-چیا-هستن؟)|
|51 | [تفاوت بین روش های ساخت یه فیلتر چیا هستن؟](#تفاوت-بین-روش-های-ساخت-یه-فیلتر-چیا-هستن؟)|
|52 | [چطوری میتونیم زنجیره ای از فیلتر ها درست کنیم؟](#چطوری-میتونیم-زنجیره-ای-از-فیلتر-ها-درست-کنیم؟)|
|53 | [ایا این امکان پذیر هست که پارامتر ها رو به فیلتر ها پاس بدیم؟](#ایا-این-امکان-پذیر-هست-که-پارامتر-ها-رو-به-فیلتر-ها-پاس-بدیم؟)|
|54 | [پلاگین ها و سرویس های مختلف اونا چیا هستن؟](#پلاگین-ها-و-سرویس-های-مختلف-اونا-چیا-هستن؟1)|
|55 | [ چطوری میتونیم یه پلاگین بسازیم؟](#چطوری-میتونیم-یه-پلاگین-بسازیم؟)|
|56 | [چطوری از یه پلاگین استفاده کنیم؟](#چطوری-از-یه-پلاگین-استفاده-کنیم؟)|
|57 | [منظور از mixin چیه؟](#منظور-از-mixin-چیه؟)|
|58 | [mixin های global چیا هستن؟](#mixin-های-global-چیا-هستن؟)|
|59 | [چطوری از mixin ها توی CLI اسفاده میکنی؟](#چطوری-از-mixin-ها-توی-CLI-اسفاده-میکنی؟)|
|60 | [منظور از merge کردن استراتژی ها توی mixin چیه؟](#منظور-از-merge-کردن-استراتژی-ها-توی-mixin-چیه؟)|
|61 | [آپشن های کاستوم برای مرج کردن استراتژی ها چیا هستن؟](#آپشن-های-کاستوم-برای-مرج-کردن-استراتژی-ها-چیا-هستن؟)|
|62 | [منظور از دستورالعمل کاستوم توی ویو چیه؟](#منظور-از-دستورالعمل-کاستوم-توی-ویو-چیه؟)|
|63 | [چطوری یه دستورالعمل رو به صورت لوکال رجیستر میکنی؟](#چطوری-یه-دستورالعمل-رو-به-صورت-لوکال-رجیستر-میکنی؟)|
|64 | [hook function های که توسط دستورالعمل ها فراهم میشن کدوما هستن؟](#hook-function-های-که-توسط-دستورالعمل-ها-فراهم-میشن-کدوما-هستن؟)|
|65 | [ارگومان های مربوط به دستورالعمل هوک چیه](#ارگومان-های-مربوط-به-دستورالعمل-هوک-چیه)|
|66 | [چطوری مقادیر رو به یه دستورالعمل میفرستی؟](#چطوری-مقادیر-رو-به-یه-دستورالعمل-میفرستی؟)|
...
|89 | [List down different builds of vuejs?](#1)|
|90 | [How do you configure vuejs in webpack?](#1)|
|91 | [What is the purpose of vuejs compiler?](#1)|
...
|137| [What is the procedure to run tests in node?](#1)|
|138| [What is the procedure to run tests in browser?](#1)|
|139| [What is the purpose of strict mode in vuex?](#1)|
|140| [Can I use strict mode in production environment?](#1)|
|141| [What is vuex plugin?](#1)|
|142| [How do you mutate state in plugins?](#1)|
|143| [What is vuex store?](#1)|
|144| [What are the differences of vuex store and plain global object?](#1)|
|145| [What is the reason not to update the state directly?](#1)|
|146| [What is Single state tree?](#1)|
|147| [How do you install vuex?](#1)|
|148| [Do I need promise for vuex?](#1)|
|149| [How do you display store state in vue components?](#1)|
|150| [How do you inject store into child components?](#1)|
|151| [What is mapState helper?](#1)|
|152| [How do you combine local computed properties with mapState helper?](#1)|
|153| [Do you need to replace entire local state with vuex?](#1)|
|154| [What are vuex getters?](#1)|
|155| [What is a property style access?](#1)|
|156| [What is a method style access?](#1)|
|157| [What is mapGetter helper?](#1)|
|158| [What are mutations?](#1)|
|159| [How do you commit with payload?](#1)|
|160| [What is object style commit?](#1)|
|161| [What are the caveats with vuex mutations?](#1)|
|162| [Why mutations should be synchronous?](#1)|
|163| [How do you perform mutations in components?](#1)|
|164| [Is it mandatory to use constants for mutation types?](#1)|
|165| [How do you perform asynchronous operations?](#1)|
|166| [What are differences between mutations and actions?](#1)|
|167| [Give an example usage of actions?](#1)|
|168| [How do you dispatch actions?](#1)|
|169| [Can you dispatch an action using payload or object?](#1)|
|170| [Can I use styled components in vuejs?](#1)|
|171| [How do you dispatch actions in components?](#1)|
|172| [How do you compose actions?](#1)|
|173| [What are modules in vuex?](#1)|
|174| [What is module local state?](#1)|
|175| [What is namespacing in vuex](#1)|
|176| [What is the default namespace behavior in vuex?](#1)|
|177| [When do you reuse modules?](#1)|
|178| [What are the principles enforced by vuex?](#1)|
|179| [Can I perform mutations directly in strict mode?](#1)|
|180| [How to use model directive with two way computed property?](#1)|
|181| [What is Vue CLI?](#1)|
|182| [What are the features provided by Vue CLI?](#1)|
|183| [What is instant prototyping?](#1)|
|184| [How do you create project using Vue CLI?](#1)|
|185| [How do you create project using GUI?](#1)|
|186| [What are plugins in vue CLI?](#1)|
|187| [How do you install plugins in an existing Vue CLI project?](#1)|
|188| [How to access local plugins in a project?](#1)|
|189| [How do you create UI plugins kind of behavior?](#1)|
|190| [What are presets?](#1)|
|191| [What is the versioning behavior in preset plugins?](#1)|
|192| [How do you allow plugin prompts?](#1)|
|193| [What are remote presets?](#1)|
|194| [Can I use local presets?](#1)|
|195| [What is the purpose of browserslist option?](#1)|
|196| [How do you find VueJS version using API?](#1)|
|197| [How do you create reactive objects](#1)|
|198| [What is the purpose new slot directive?](#1)|
|199| [What is the use of compile method?](#1)|
|200| [What does nextTick do in VueJS?](#1)|
...
36.  ### data flow مربوط به پراپ ها چطوری هست؟
     ...
     2. When you try to transform the parent prop: You can define a computed property using the prop’s value,
...
181. ### What is Vue CLI?
     ...
     **نکته:** Vue CLI requires Node.js version 8.9 or above (8.11.0+ recommended).
